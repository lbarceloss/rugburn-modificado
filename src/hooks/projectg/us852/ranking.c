...
inline static stMsgObject MakeMsgObject(LPVOID _pIActor, DWORD _id, DWORD _c0, DWORD _c1, DWORD _c2,
                                        DWORD _c3, DWORD _c4) {
    stMsgObject obj;
...
VOID InitUS852RankingHook() {
    ...
    pIActorHandleMsg = (PFNVIRTUALIACTORHANDLEMSGPROC)BuildStdcallToVirtualThiscallThunk(0x2Cu);
    pIActorCloseAllDialogs =
        (PFNVIRTUALIACTORCLOSEALLDIALOGSPROC)BuildStdcallToVirtualThiscallThunk(0x3Cu);
    pFrFormOpen = (PFNFRFORMOPENPROC)BuildStdcallToVirtualThiscallThunk(0x64u);
